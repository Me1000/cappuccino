...
+ (CPTextField)themedNonEditableLabelTextFieldWithFocusRing
{
...
/*+ (CPTextField)themedWrappingTextFieldWithFocusRing
{
   var textfield = [self themedStandardTextFieldWithFocusRing];
    [textfield setWraps:YES];
    [textfield setFrame:CGRectMake(0,0,90,70)];
...
+ (CPPopUpButton)themedSegmentedControl
{
    ...
    [segmentedControl setValue:CGInsetMake(0.0, 5.0, 0.0, 4.0) forThemeAttribute:@"content-inset" inState:CPThemeStateNormal];
